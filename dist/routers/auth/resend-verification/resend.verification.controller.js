...
export const ResendVerificationController = async (req, res, next) => {
    try {
        ...
        if (recentVerification) {
            throw new CustomError(HttpRes.status.TOO_MANY_REQUESTS, HttpRes.message.TOO_MANY_REQUESTS, 'Please wait 1 minute before requesting a new verification code');
        }
