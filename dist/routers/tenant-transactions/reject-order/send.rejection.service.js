...
export class SendRejectionService {
    ...
    static async sendBookingRejectionEmail(bookingId) {
        ...
        await this.sendEmail(booking.email, `Payment Proof Rejected - ${templateData.order_id}`, 'rejected.booking.html', templateData);
    }
}
