...
export class SendReminderService {
    ...
    static async sendBookingReminderEmail(bookingId) {
        ...
        await this.sendEmail(booking.email, `Reminder: Your stay begins tomorrow - ${templateData.uid}`, 'order.reminder.html', templateData);
    }
}
