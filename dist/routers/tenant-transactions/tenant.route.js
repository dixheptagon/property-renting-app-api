...
tenantRouter.get('/tenant/get-order-list', verifyToken, verifyTenant, GetOrderListByTenantController);
// Get Property List by Tenant
tenantRouter.get('/tenant/get-property-list', verifyToken, verifyTenant, GetPropertyListByTenantController);
// Confirm Order by Tenant
tenantRouter.post('/tenant/:orderId/confirm-order', verifyToken, verifyTenant, ConfirmOrderController);
// Reject Order by Tenant
tenantRouter.post('/tenant/:orderId/reject-order', verifyToken, verifyTenant, RejectOrderController);
