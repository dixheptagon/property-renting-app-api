...
exports.sendPropertyUploadFailedEmail = void 0;
const path = __importStar(require("path"));
const fs = __importStar(require("fs"));
const Handlebars = __importStar(require("handlebars"));
const nodemailer_transporter_1 = __importDefault(require("../../../../lib/config/nodemailer.transporter"));
const sendPropertyUploadFailedEmail = (_a) => __awaiter(void 0, [_a], void 0, function* ({ email, errorMessage, }) {
    try {
        // Generate timestamp
...
exports.sendPropertyUploadFailedEmail = sendPropertyUploadFailedEmail;
