...
exports.AutoDeleteTempPropertyImage = void 0;
...
// Auto-delete temp property images cron job
const AutoDeleteTempPropertyImage = () => {
    // Run daily at 02:00 server time
    node_cron_1.default.schedule('0 2 * * *', () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            // Calculate date 7 days ago
            const sevenDaysAgo = new Date(Date.now() - 7 * 24 * 60 * 60 * 1000);
            const tempImages = yield prisma_client_1.default.propertyImage.findMany({
                where: {
                    status: 'temp',
                    updated_at: {
                        lt: sevenDaysAgo,
            ...
            for (const image of tempImages) {
                try {
                    ...
                    yield prisma_client_1.default.propertyImage.delete({
                        where: { id: image.id },
                    });
                }
                catch (error) {
            ...
            console.error('Error in auto-delete temp property images cron job:', error);
        }
    }));
};
exports.AutoDeleteTempPropertyImage = AutoDeleteTempPropertyImage;
