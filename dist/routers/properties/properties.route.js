...
propertiesRouter.post('/properties/upload-property-images', verifyToken, verifyTenant, uploadPropertyImage().array('images', 10), // Allow up to 10 images
...
propertiesRouter.delete('/properties/images/:imageId', verifyToken, verifyTenant, propertyImageDeleteController);
// DELETE /api/properties/images/:imageId/:temp_group_id
propertiesRouter.delete('/properties/images/:imageId/:temp_group_id', verifyToken, verifyTenant, propertyImageDeleteController);
// PUT /api/properties/images/:imageId/set-main
propertiesRouter.put('/properties/images/:imageId/set-main', verifyToken, verifyTenant, setPropertiesMainImageController);
// POST /api/properties/upload-property
propertiesRouter.post('/properties/upload-property', verifyToken, verifyTenant, uploadPropertyController);
// POST /api/properties/move-images/:propertyId
propertiesRouter.put('/properties/move-images/:propertyId', verifyToken, verifyTenant, movePropertyImagesController);
// GET /api/properties/explore-properties
propertiesRouter.get('/properties/explore-properties', retrievePropertyListController);
// GET /api/properties/:uid/property-details
propertiesRouter.get('/properties/:uid/property-details', getPropertyDetailsController);
// GET /api/properties/my-properties
propertiesRouter.get('/properties/my-properties', verifyToken, verifyTenant, getOwnedPropertyIdController);
// GET /api/properties/room-types
propertiesRouter.get('/properties/room-types', getRoomTypesByPropertyIdController);
